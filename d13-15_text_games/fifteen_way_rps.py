...
def game_loop(player_name):
    ...
    while game_ongoing:
        print()
        print("Score: {} {} : Computer {}".format(human_player.name, human_player.score, computer_player.score))
        print()
        valid_roll = True
        ...
        if valid_roll:
            ...
            if computer_roll == roll.roll_name:
                ...
                print("Your {} beat the computer's {}".format(roll.roll_name, computer_roll))
                human_player.score += 1
            elif computer_roll in roll.losses:
                print("Your {} lost to the computer's {}".format(roll.roll_name, computer_roll))
