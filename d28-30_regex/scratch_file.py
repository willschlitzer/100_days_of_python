...
def basicRegex():
    oki = "I have lived in Okinawa for 2 years"
    america = "I have lived in America for 20 years"
    m = re.search(r"(for \d+ years)", oki)
    print(m.groups())
...
def useFindall():
    ...
    # Finds any parts of the string with one or more letter
